//Sample code 
//Write an OpenCL program to read two arrays A and B of same size N. 
//Find the sum of corresponding array elements. Store the resuult in array C
...
int main(void){
	...
	cl_kernel kernel = clCreateKernel(program, "vector_add", &ret); //create OpenCL kernel object
