//Write an OpenCL program which takes N binary numbers as input and stores the 
//one's complement of each element in another array in parallel
//Wrong/Incomplete
#include <stdio.h>
#include <CL/cl.h>
#include <stdlib.h>
...
int main(void){
	...
	cl_kernel kernel = clCreateKernel(program, "ones_complement", &ret); //create OpenCL kernel object
