//Write an OpenCL program which takes N(even no) integers into an ID array 
//and modifies the same array by swaping adjacent elements in parallel
//incomplete
...
int main(void){
	...
	cl_kernel kernel = clCreateKernel(program, "swap", &ret); //create OpenCL kernel object
