//Write an OpenCL program which takes N binary numbers as input. It converts
//these values into thier corresponding decimal values (base 10) and stores the 
//results in another array in parallel
...
int main(void){
	...
	cl_kernel kernel = clCreateKernel(program, "decimal", &ret); //create OpenCL kernel object
