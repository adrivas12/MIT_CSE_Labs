...
void insertST(char id[], char data_type[])
{
	if(searchST(id, data_type)==-1)
	{
		...
		else if(strcmp(data_type, "function")==0)
		{
			...
			//strcpy(n->ret_type, return_types); 
			//if(strcmp(n->lexname, "printf")==0 || strcmp()
		}
